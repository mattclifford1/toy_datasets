...
DATASET_SHORT_NAMES: dict[str, str] = {
    ...
    'Thyroid Sick': 'Thyroid Sick',
    'Stroke Prediction': 'Stroke',
    'Framingham CHD': 'Framingham',
    'Thoracic Surgery': 'Thoracic',
    'SPECTF Heart': 'SPECTF',
    'Heart Failure': 'Heart Failure',
    'Mammographic Mass': 'Mammographic',
    'Breast Cancer Prognostic': 'BC Prognostic',
    'Breast Cancer Coimbra': 'BC Coimbra',
    'HCC Survival': 'HCC Survival',
    'Z-Alizadeh Sani CAD': 'Z-Alizadeh CAD',
