...
class TestStratifiedSubsample:
    ...
    def test_stratified_subsample_preserves_ratio(self):
        ...
        X_sub, y_sub = utils.stratified_subsample(X, y, n_samples=100)
    ...
    def test_stratified_subsample_reproducible(self):
        ...
        X1, y1 = utils.stratified_subsample(X, y, n_samples=20, random_state=42)
        X2, y2 = utils.stratified_subsample(X, y, n_samples=20, random_state=42)
...
class TestProportionalDownsample:
    ...
    def test_proportional_downsample_size(self, sample_data):
        ...
        downsampled = utils.proportional_downsample(
    ...
    def test_proportional_downsample_invalid_percent(self, sample_data):
        ...
        with pytest.raises(ValueError):
            utils.proportional_downsample(sample_data.copy(), percent_of_data=0)

        with pytest.raises(ValueError):
            utils.proportional_downsample(sample_data.copy(), percent_of_data=101)
    ...
    def test_proportional_downsample_minimum_samples(self):
        ...
        downsampled = utils.proportional_downsample(data.copy(), percent_of_data=1)
